    ...
    <>
      ...
      {item.menu && (
        <div
          ...
          } text-sm border-b border-gray-100 lg:border lg:bg-pastelBrownTheme-cardColor lg:absolute lg:top-full lg:left-0 lg:min-w-full lg:z-20 lg:rounded-lg lg:shadow-lg lg:dark:bg-dark-900 dark:border-dark-700`}
        >
          <ClickOutside
