      ...
      <div
        className={`${corners !== 'rounded-full' ? corners : 'rounded-3xl'} ${
          design === ContactFormDesigns.SIMPLE_CLEAN_DIVERSITY
            ? 'bg-pastelBrownTheme-diversityContact '
            : 'bg-pastelBrownTheme-buttonColor'
        } p-12  mb-16`}
      >
          ...
          >
            ...
            <div className='space-y-2'>
              ...
              >
                ...
                />
                <a href='hannahsricci@gmail.com'>hannahsricci@gmail.com</a>
              </p>
            </div>
          </div>
          <div>
              ...
              {({ isSubmitting }) => (
                ...
                >
                  ...
                  <BaseButton
                    ...
                    className={`w-1/2 md:w-1/4 text-sm mt-4 text-pastelBrownTheme-buttonColor   ${corners}`}
