            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>NominalSize</p>
                    <p className={'line-clamp-2'}>{item.nominal_size}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>ActualSize</p>
                    <p className={'line-clamp-2'}>{item.actual_size}</p>
                  </div>
