...
import { create } from '../../stores/joinery_methods/joinery_methodsSlice';
...
Joinery_methodsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_JOINERY_METHODS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Joinery_methodsNew;
